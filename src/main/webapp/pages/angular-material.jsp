...
<body data-ng-app="firstApplication" data-ng-cloak>
	<div data-ng-controller="autoCompleteController as ctrl"
		layout="column" data-ng-cloak>
		<md-content class="md-padding">
		<form data-ng-submit="$event.preventDefault()">
			<p>
				<code>md-autocomplete</code>
				can be used to provide search results from local or remote data
				sources.
			</p>
			<md-autocomplete ng-disabled="ctrl.isDisabled"
				...
				placeholder="US State?"> <md-item-template>
			...
			<br />
			<md-checkbox ng-model="ctrl.simulateQuery">Show
			progress for results?</md-checkbox>
			<md-checkbox ng-model="ctrl.noCache">Disable caching?</md-checkbox>
			<md-checkbox ng-model="ctrl.isDisabled">Disable?</md-checkbox>
			<p>
				<code>md-autocomplete</code>
				caches results when performing a query. After first call, it uses
				the cached results to eliminate unnecessary server requests or
				lookup logic and it can be disabled.
			</p>
		</form>
		</md-content>
	</div>
